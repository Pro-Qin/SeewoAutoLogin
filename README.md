...
| 安装包 | 体积 | 适用场景 |
|---|---|---|
| `SeewoAutoLogin_Setup_v1.10.2.exe` | 约 8MB | 能联网：缺运行时由程序自动下载并静默安装 |
| `SeewoAutoLogin_Setup_v1.10.2_WithWebView2.exe` | 约 210MB | 断网 / 内网机器：安装时离线装好 WebView2，杜绝运行时缺失导致的白屏 |
